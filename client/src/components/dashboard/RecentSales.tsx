function RecentSalesTableItem(){
    return(
        <div className="flex items-center justify-between w-full max-sm:w-[500px] h-8 border-b border-gray-200 cursor-pointer pt-4 mt-1 hover:bg-gray-200 transition duration-300 bg-gray-50">
...
function RecentSales(){
    return(
        <div className="bg-white flex flex-col w-full h-[95%] px-5 border border-gray-200 rounded-2xl shadow">
            ...
            <div className="flex flex-col justify-start items-start overflow-scroll hide-scrollbar h-[80%] max-sm:h-[85%] rounded-b-lg">
                <div className="text-xs text-gray-900 font-semibold w-full max-sm:w-[500px] h-10 border-b border-gray-200 sticky top-0 bg-gray-50 flex justify-between items-center py-2">
                    <p>Time</p>
                    <p>Date</p>
                    <p>Drug Name</p>
                    <p>Price</p>
