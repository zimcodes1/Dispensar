function RecentSalesTableItem(){
    return(
        <div className="flex items-center justify-between w-full max-sm:w-[500px] md:w-full h-8 border-b border-gray-200 cursor-pointer pt-4 mt-1 hover:bg-gray-200 transition duration-300 bg-gray-50">
