...
function Topbar() {
  ...
  return (
    <div
      className={`flex w-full h-[60px] max-sm:h-[50px] max-sm:pl-12 px-5 items-center justify-between fixed top-0 z-50 border-b transition-colors duration-300 ${
    ...
    >
      <div className="flex justify-center items-center">
        ...
        <h1
          className={`text-2xl max-sm:text-lg font-semibold transition-colors duration-300 ${
      ...
      <div className="flex w-auto h-full justify-between items-center gap-4 max-sm:gap-0">
        ...
        <p
          className={`text-md mx-2 transition-colors duration-300 ${
