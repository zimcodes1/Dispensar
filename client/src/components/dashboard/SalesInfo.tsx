...
function SalesInfo(){
    ...
    <>
        ...
        <div className="bg-white w-[40%] max-sm:mt-5 max-[767px]:w-full md:w-[38%] max-[767px]:h-[250px] md:h-[280px] max-[767px]:mt-2 h-full shadow shadow-green-200 border border-green-300 rounded-2xl px-5 flex-col  overflow-scroll hide-scrollbar">
