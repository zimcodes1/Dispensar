...
function SalesInfo(){
    ...
    <>
        ...
        <div className="bg-white w-[40%] max-[767px]:w-full md:w-[38%] max-[767px]:h-[200px] md:h-[280px] max-[767px]:mt-2 h-full shadow border border-gray-200 rounded-2xl px-5 flex-col  overflow-scroll hide-scrollbar">
