...
function EmployeeSettings(){
    return(
        <div className="w-full h-full p-2 flex flex-col">
            <h1 className="text-2xl max-sm:text-lg text-center text-gray-900">Account Settings</h1>
            <div className="flex w-full h-fit flex-col">
                ...
                <div className="flex flex-col w-[60%] max-sm:w-[90%] mx-auto items-start border-2 bg-white border-gray-200 rounded-xl p-3">
