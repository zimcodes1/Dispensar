      ...
      <div className="space-y-4 overflow-x-auto lg:overflow-x-visible">
        <div className="min-w-[500px] lg:min-w-0 space-y-4">
          {demoItems.map((item, index) => (
            <div
              key={index}
              className={`flex items-center justify-between p-4 rounded-lg ${isDarkMode ? "bg-gray-700" : "bg-white"}`}
            >
              ...
              <div className="ml-4 w-24">
                <div
                  className={`h-2 rounded-full relative ${isDarkMode ? "bg-gray-600" : "bg-gray-200"}`}
                >
                  <div
                ...
                <p
                  className={`text-xs mt-1 text-center ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}
                >
