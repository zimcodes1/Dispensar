...
function Login() {
	...
	useEffect(() => {
		document.title = "Login to your account | Dispensar";
	});
	return (
		<div
		...
		>
			...
			>
				<div className="flex flex-col justify-center items-center w-full pt-10 max-sm:pt-20">
					...
					>
						Welcome to <span className="text-green-400">Dispensar</span>
					</h1>
					<p
				...
				<form className="flex flex-col w-full px-10 mt-8">
					<input
						...
						className={`p-3 rounded-lg mb-4 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 ${isDarkMode ? "bg-gray-700 border border-gray-600 text-white placeholder-gray-400" : "bg-gray-100 border border-gray-300 text-gray-900 placeholder-gray-500"}`}
					/>
					<input
						type="password"
						placeholder="Password"
						className={`p-3 rounded-lg mb-6 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 ${isDarkMode ? "bg-gray-700 border border-gray-600 text-white placeholder-gray-400" : "bg-gray-100 border border-gray-300 text-gray-900 placeholder-gray-500"}`}
					/>
					<button
						type="submit"
					...
					>
						Log In <i className="bx bx-right-arrow-alt"></i>
					</button>
				</form>
				{/*Forgotten Password */}
