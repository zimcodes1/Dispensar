                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <Link to="/" className="flex items-center gap-3">
                        ...
                        <span className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                            <span className="text-green-500">Dispensar</span> Workflows
                        </span>
                    </Link>
                    <Link to="/signup">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                ...
                >
                    ...
                    <p className={`text-xl max-sm:text-base max-w-3xl mx-auto ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                        Dispensar adapts to your pharmacy's unique operational structure. Select the workflow that matches your team size and business needs.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-blue-900/20 border border-blue-800' : 'bg-blue-50 border border-blue-200'}`}>
                        <p className={`text-sm ${isDarkMode ? 'text-blue-300' : 'text-blue-800'}`}>
                            ...
                            <strong>Best for:</strong> Solo pharmacists, small neighborhood pharmacies, or low-traffic operations
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-green-900/20 border border-green-800' : 'bg-green-50 border border-green-200'}`}>
                        <p className={`text-sm ${isDarkMode ? 'text-green-300' : 'text-green-800'}`}>
                            <i className='bx bx-info-circle mr-2'></i>
                            <strong>Best for:</strong> Medium to large pharmacies, high-traffic locations, or operations prioritizing accuracy and compliance
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-8">
                        <div>
                            ...
                            <div className={`mt-6 p-4 rounded-lg ${isDarkMode ? 'bg-purple-900/20 border border-purple-800' : 'bg-purple-50 border border-purple-200'}`}>
                                <p className={`text-sm ${isDarkMode ? 'text-purple-300' : 'text-purple-800'}`}>
                                    <i className='bx bx-shuffle mr-2'></i>
                                    <strong>Flexible Assignment:</strong> The person who bills and collects payment can also dispense, or a separate dispenser can handle it
                                </p>
                            </div>
                        </div>
                    ...
                    <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-purple-900/20 border border-purple-800' : 'bg-purple-50 border border-purple-200'}`}>
                        <p className={`text-sm ${isDarkMode ? 'text-purple-300' : 'text-purple-800'}`}>
                            <i className='bx bx-info-circle mr-2'></i>
                            <strong>Best for:</strong> Small to medium pharmacies with 2-3 staff members, or operations needing flexible role assignments
                        </p>
                    </div>
                </motion.div>
                    ...
                    <div className={`overflow-x-auto rounded-xl border ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                        <table className="w-full min-w-[600px]">
                            <thead className={isDarkMode ? 'bg-gray-800' : 'bg-gray-100'}>
                                <tr>
                                    <th className={`p-4 text-left ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Feature</th>
                                    <th className={`p-4 text-center ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Single Worker</th>
                                    <th className={`p-4 text-center ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Three-Role</th>
                                    <th className={`p-4 text-center ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Dual Role</th>
                                </tr>
                            </thead>
                            <tbody className={isDarkMode ? 'bg-gray-800/50' : 'bg-white'}>
                                <tr className={isDarkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}>
                                    <td className={`p-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Staff Required</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>1</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>3</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>2</td>
                                </tr>
                                <tr className={isDarkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}>
                                    <td className={`p-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Processing Speed</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Fast</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Very Fast</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Moderate</td>
                                </tr>
                                <tr className={isDarkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}>
                                    <td className={`p-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Error Checking</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Basic</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Excellent</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Good</td>
                                </tr>
                                <tr className={isDarkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}>
                                    <td className={`p-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Flexibility</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Low</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Low</td>
                                    <td className={`p-4 text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>High</td>
                                </tr>
                                <tr className={isDarkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}>
                                    <td className={`p-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Best For</td>
                                    <td className={`p-4 text-center text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Small shops</td>
                                    <td className={`p-4 text-center text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Busy pharmacies</td>
                                    <td className={`p-4 text-center text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Growing teams</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                >
                    ...
                    <p className={`text-lg mb-8 max-w-2xl mx-auto ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                        Choose your workflow and start streamlining your pharmacy operations today. You can always switch workflows later as your needs change.
                    </p>
