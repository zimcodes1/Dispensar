...
const Settings = () => {
	...
	const [newUserImage, setNewUserImage] = useState<string | undefined>(
		undefined,
	);
	newUserImage;
	//use api to get the user's information
	...
	useEffect(() => {
		document.title = "Settings | Dispensar";
	});
		...
		<>
			...
			>
				...
				<div className="flex w-[78%] md:w-[calc(100%-4rem)] lg:w-[78%] max-[767px]:w-full h-full flex-col max-[767px]:px-2 md:px-4 py-6">
					<div className="mb-6">
						<h1
							className={`text-2xl max-sm:text-lg font-semibold transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
						>
							Settings
						</h1>
						<p
					...
					>
						<div
							className={`border-b overflow-x-auto transition-colors duration-300 ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
						>
						...
						<div className="p-6">
							...
							{activeTab === "profile" && (
								<div className="space-y-6">
									<div className="flex items-center gap-6">
										<div
											className={`w-24 h-24 rounded-full overflow-hidden transition-colors duration-300 ${isDarkMode ? "bg-gray-700" : "bg-gray-200"}`}
										>
											<img
										...
										<div>
											...
											/>
											<p
												className={`text-xs mt-2 transition-colors duration-300 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}
											>
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
										<div>
											<label
												className={`block text-sm font-medium mb-1 transition-colors duration-300 ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}
											>
												Full Name
											</label>
											<input
									...
									<div className="flex justify-end gap-3">
										<button
											className={`px-4 py-2 text-sm transition-colors duration-300 ${isDarkMode ? "text-gray-300 hover:text-white" : "text-gray-700 hover:text-gray-900"}`}
										>
											Cancel
										</button>
							...
							{activeTab === "notifications" && (
								<div className="space-y-4">
									<div
										className={`flex items-center justify-between py-3 border-b transition-colors duration-300 ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
									>
										<div>
											<p
												className={`text-sm font-medium transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
											>
												Push Notifications
											</p>
											<p
										...
										<label className="relative inline-flex items-center cursor-pointer">
											...
											/>
											<div
												className={`w-11 h-6 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5  after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600 transition-colors duration-300 ${
													isDarkMode
							...
							{activeTab === "security" && (
								<div className="space-y-6">
									<div>
										<h3
											className={`text-sm font-semibold mb-4 transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
										>
											Change Password
										</h3>
										<div className="space-y-4">
									...
									<div
										className={`border-t pt-6 transition-colors duration-300 ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
									>
										<h3
											className={`text-sm font-semibold mb-4 transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
										>
										...
										>
											<div className="flex items-start justify-between">
												<div>
													<p
														className={`text-sm font-medium transition-colors duration-300 ${isDarkMode ? "text-red-400" : "text-red-900"}`}
													>
														Logout
													</p>
													<p
														className={`text-xs mt-1 transition-colors duration-300 ${isDarkMode ? "text-red-500" : "text-red-700"}`}
													>
			...
			{showLogoutModal && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
					...
					>
						...
						<h3
							className={`text-lg font-semibold text-center mb-2 transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
						>
							Logout
						</h3>
						<p
							className={`text-sm text-center mb-6 transition-colors duration-300 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
						>
